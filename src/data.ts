...
export const loosingGifsArray:string[] = [
    `<img class="hangman__image" src="https://media.tenor.com/FFurq2xQgeoAAAAM/taylor-swift-cheers.gif" alt="Taylor saying dont hate the player hate the game">`,
    `<img class="hangman__image" src="https://media4.giphy.com/media/v1.Y2lkPTc5MGI3NjExaTF4NmI4cGJqa3VjMXMyNTNxbGp4b2wxeGdrdGx4b2ZkaDZyOTVndiZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/jbcJ7iSy9pPkxKmqaI/giphy.webp" alt="Taylor saying dont hate the player hate the game">`,
    `<img class="hangman__image" src="https://i.giphy.com/3rgXBt9KoMxnpgB2RG.webp" alt="Taylor saying dont hate the player hate the game">`,
    `<img class="hangman__image" src="https://i.giphy.com/a4gLl8darNId2.webp" alt="Taylor saying dont hate the player hate the game">`,
    `<img class="hangman__image" src="https://media3.giphy.com/media/v1.Y2lkPTc5MGI3NjExajlzNHRxMXljNHB0ZXZ0YzQwM3hodDA2OGE3aHBoMmYyOGE5eHJ6dCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/3o6gg6NkLsub7EzIgE/giphy.webp" alt="Taylor saying dont hate the player hate the game">`,
]

export const winningGifsArray :string[] = [
    `<img class="hangman__image" src="https://media0.giphy.com/media/v1.Y2lkPTc5MGI3NjExbmVvZzhxeGV6YWQyenFnOXkzbjd2ZzlmZWs5NGl1cG8xZ2w1aXl1diZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/11wKUA9rPyvyuI/giphy.webp" alt="Taylor celebrating">`,
    `<img class="hangman__image" src="https://assets.teenvogue.com/photos/55b271a774dfbc51751ef24a/master/w_1600,c_limit/taydance4.gif" alt=Taylor celebrating">`,
    `<img class="hangman__image" src="https://assets.teenvogue.com/photos/55b271a474dfbc51751ef240/master/w_1600,c_limit/taydance5.gif" alt="Taylor celebrating">`,
    `<img class="hangman__image" src="https://media2.giphy.com/media/v1.Y2lkPTc5MGI3NjExM3R1anJkcDR4NW8zbGpvbzVjaHF1NDNzemlmMWpzYXQ2OGN5MTZtZCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/hRFhL1ZFrSwpOg4HpS/giphy.webp" alt="Taylor celebrating">`,
    `<img class="hangman__image" src="https://i.giphy.com/cyBFFJ9kErbuw8xNXc.webp" alt="Taylor celebrating">`,
]

export const loosingPhrases = [
    ...
    `Said, "I'm fine, but it wasn't true. You didnt get the answer `
]
